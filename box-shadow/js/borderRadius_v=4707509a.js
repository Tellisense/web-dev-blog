function BorderRadius(options) {
  ...
  this.borderBackground = options["borderBackground"] || "#ff69b4";
}
...
BorderRadius.prototype.refresh = function () {
  var cssCode1 = "",
    cssCode2 = "";
  cssCode1 +=
    this.topLeft + "px " + this.topRight + "px " + this.bottomRight + "px ";
...
$("body").ready(function () {
  ...
  $("#br-background-color").live("change", function () {
    ...
    borderRadius.refresh();
    $("#br-background-color-button").css(
      "background-color",
      "#" + $(this).val()
    );
  });
